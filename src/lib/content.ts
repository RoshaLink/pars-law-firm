...
export const TEAM: TeamMember[] = [
  { id: "sara-rostami", name: "Sara Rostami", role: { en: "Founding Partner, Immigration", fa: "شریک مؤسس، مهاجرت" }, initials: "SR", photo: "/images/team/sara-rostami.webp" },
  { id: "daniel-farrokh", name: "Daniel Farrokh", role: { en: "Partner, Family Law", fa: "شریک، حقوق خانواده" }, initials: "DF", photo: "/images/team/daniel-farrokh.webp" },
